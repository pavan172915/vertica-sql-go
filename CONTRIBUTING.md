...
If you find a bug, submit an [issue](https://github.com/pavan172915/vertica-sql-go/issues) with a complete and reproducible bug report. If the issue can't be reproduced, it will be closed. If you opened an issue, but figured out the answer later on your own, comment on the issue to let people know, then close the issue.
...
You can open an [issue](https://github.com/pavan172915/vertica-sql-go/issues)
...
Fork the project [on Github](https://github.com/pavan172915/vertica-sql-go) and check out your copy locally.
